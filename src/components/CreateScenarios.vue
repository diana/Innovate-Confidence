    ...
    <div class="create-scenarios">
        <div class="wrap-contact100">
            <form @submit.prevent="onSubmit" class="contact100-form validate-form">
                ...
                <label class="label-input100">Scenario Description</label>
                <div class="wrap-input100 validate-input alert-validate">
                    <textarea 
                        ...
                        required
                        class="input100"
                        placeholder="Please enter information about the scenario here..."
                    />
                </div>
            ...
            <p>*if you have not uploaded your photo, imugr.com is a great option for free photo uploads</p>
